"use strict";
/* 넘버원 김포B 공비 - 안정성·API·캐시 최적화 20260716-51 */
...
const DIAGNOSTIC_APP_SHELL = Object.freeze([
    "./", "./index.html", "./style.css?v=20260716-51", "./number-one.css?v=20260716-51", "./script.js?v=20260716-51", "./number-one.js?v=20260716-51", "./manifest.json",
...
/* ========================= 성능 판정 현실화 v24 ========================= */
const FINAL_BUILD_INFO = Object.freeze({ fileVersion: "20260716-51", serviceWorkerVersion: "v76" });
...
const V25_UI_CONFIG = Object.freeze({
    fileVersion: "20260716-51",
    serviceWorkerVersion: "v76",
