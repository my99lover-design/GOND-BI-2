"use strict";
/* 넘버원 김포B 공비 - 공동비번 삭제 연결·안전모드 복구판 20260716-10 */
...
const DIAGNOSTIC_APP_SHELL = Object.freeze([
    "./", "./index.html", "./style.css?v=20260716-10", "./script.js?v=20260716-10", "./manifest.json",
...
/* ========================= 성능 판정 현실화 v24 ========================= */
const FINAL_BUILD_INFO = Object.freeze({ fileVersion: "20260716-10", serviceWorkerVersion: "v35" });
...
const V25_UI_CONFIG = Object.freeze({
    fileVersion: "20260716-10",
    serviceWorkerVersion: "v35",
